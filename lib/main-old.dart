...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar:AppBar(
             title:Image.asset("assets/images/info-box9.png",height: 40.0,),
            elevation: 0.0,
          centerTitle: true,
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                ...
                _buildCard('Joji', 'Away', 2),
                _buildCard('Yoshi', 'Available', 3),
                _buildCard('Mario', 'Available', 4),
              ],
            )
          ],
        )
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(
                              'assets/images/blog-details-author.png'
                          )
                      )
                  ),
                ),
