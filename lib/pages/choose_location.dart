...
class _ChooseLocationState extends State<ChooseLocation> {
  ...
  List<WorldTime> locations = [
    ...
    WorldTime(urlAtt: 'Australia/Sydney', location: 'Sydney', flag: 'Australia.png'),
    ...
    WorldTime(urlAtt: 'America/New_York', location: 'New York', flag: 'usa.png'),
    WorldTime(urlAtt: 'Asia/Seoul', location: 'Seoul', flag: 'south_korea.png'),
    WorldTime(urlAtt: 'Asia/Jakarta', location: 'Jakarta', flag: 'indonesia.png'),
